...
function inst_atual(){
    ...
    {  
        ...
        nota1.classList.add("seis");
        nota1.textContent = "6";
        link1.href = "partituralogin.html?partitura=giornotheme"

        imgm2.src = "img/lazytown.jpg";
        nomem2.textContent = "            We Are Number One        -  Lazy Town -";
        nota2.classList.add("dois");
        nota2.textContent = "2";
        link2.href = "partituralogin.html?partitura=lazytown"
        ...
        nota4.classList.add("oito");
        nota4.textContent = "8";
        link4.href = "partituralogin.html?partitura=pianoconcerto"
    ...
    else if(inst_param === "violino")
    {
        ...
        nota4.classList.add("sete");
        nota4.textContent = "7";
        link4.href = "partituralogin.html?partitura=canonind";
    ...
    else if(inst_param === "saxofone")
    {
        ...
        nota4.classList.add("sete");
        nota4.textContent = "7";
        link4.href = "partituralogin.html?partitura=sevennationarmy";
    }
}