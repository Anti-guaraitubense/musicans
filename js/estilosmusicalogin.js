...
function gen_atual(){
    ...
    {  
        ...
        nota1.classList.add("quatro");
        nota1.textContent = "4";
        link1.href = "partituralogin.html?partitura=herecomesthesun"

        imgm2.src = "img/believer.jpg";
        nomem2.textContent = "           Believer        - Imagine Dragons - ";
        nota2.classList.add("seis");
        nota2.textContent = "6";
        link2.href = "partituralogin.html?partitura=hesapirate";

        imgm3.src = "img/metalica.jpeg";
        nomem3.textContent = "      Nothing Else Matters  -    Metallica   - ";
        nota3.classList.add("quatro");
        nota3.textContent = "4";
        link3.href = "partituralogin.html?partitura=nothingelsematters";

        imgm4.src = "img/intheend.jpg";
        nomem4.textContent = "          In The End        -   Linkin Park - ";
        nota4.classList.add("cinco");
        nota4.textContent = "5";
        link4.href = "partituralogin.html?partitura=intheend";
    ...
    else if(gen_param === "hiho")
    {
        ...
        link4.href = "partituralogin.html?partitura=supermarioworldthemeragtime";
